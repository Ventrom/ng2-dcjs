...
(function () {
    ...
    dc.baseMapChart = function (_chart) {
        ...
        var _mapOptions = {attributionControl: false, minZoom: 1, maxZoom: 10};
...
(function () {
    ...
    dc.baseLeafletChart = function (_chart) {
        ...
        _chart._doRender = function () {
            if (_chart.root().node()._leaflet) return _chart._doRedraw();

            var _map = L.map(_chart.root().node(), _chart.mapOptions());
            _map._tileLayersToLoad = 0;
    ...
    dc.leafletMarkerChart = function (parent, chartGroup) {
        ...
        _chart._postRender = function () {
            ...
            var filterControl = L.Control.extend({
                ...
                onAdd: function (map) {
                    ...
                    if (!_filterByArea) L.DomUtil.addClass(container, 'disabled');
        ...
        _chart._doRedraw = function () {
            ...
            groups.forEach(function (v,i) {
                ...
                var markerOpacity = curFilters.length ? 0.6 : 1.0;
            ...
            } else if (_fitOnRender) {
                var featureGroup = new L.featureGroup(allMarkers);
                _chart.map().fitBounds(featureGroup.getBounds());
            }
    ...
    dc.paginationMixin = function (_chart, size) {
        ...
        if (_chart) {
            ...
            if (_chart.y) {
                ...
                //_chart.rowsCap(_chart.pagination.pageSize)
                //_chart.othersGrouper(false)
            }
